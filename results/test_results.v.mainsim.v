...
//***************************************************************************//
//                                                                           //
//  FILE CREATED..............April 16, 2026 at 12:16:46                     //
//                                                                           //
//  PROJECT NAME..............dt2                                            //
//                                                                           //
//  TESTMODE..................FULLSCAN                                       //
...
//***************************************************************************//
  ...
  processor
    processor_inst (
      .clk        ( part_PIs[001] ),      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
      .reset      ( part_PIs[002] ),      // pinName = reset;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
      .scan_en    ( part_PIs[003] ),      // pinName = scan_en;  tf = +SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_in    ( part_PIs[004] ),      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .test_mode  ( part_PIs[005] ),      // pinName = test_mode; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_out   ( part_POs[015] ),      // pinName = scan_out;  tf =  SO  ; 
      .A_out      ({part_POs[008]  ,      // pinName = A_out[7]; 
                    part_POs[007]  ,      // pinName = A_out[6]; 
                    part_POs[006]  ,      // pinName = A_out[5]; 
                    part_POs[005]  ,      // pinName = A_out[4]; 
                    part_POs[004]  ,      // pinName = A_out[3]; 
                    part_POs[003]  ,      // pinName = A_out[2]; 
                    part_POs[002]  ,      // pinName = A_out[1]; 
                    part_POs[001]}),      // pinName = A_out[0]; 
      .PC_out     ({part_POs[013]  ,      // pinName = PC_out[4]; 
                    part_POs[012]  ,      // pinName = PC_out[3]; 
                    part_POs[011]  ,      // pinName = PC_out[2]; 
                    part_POs[010]  ,      // pinName = PC_out[1]; 
                    part_POs[009]}),      // pinName = PC_out[0]; 
      .halted_out ( part_POs[014] )     // pinName = halted_out; 
      );
...
//***************************************************************************//
  ...
  assign ( weak0, weak1 ) // Termination 
    part_POs [1] = global_term,     // pinName = A_out[0]; 
    part_POs [2] = global_term,     // pinName = A_out[1]; 
    part_POs [3] = global_term,     // pinName = A_out[2]; 
    part_POs [4] = global_term,     // pinName = A_out[3]; 
    part_POs [5] = global_term,     // pinName = A_out[4]; 
    part_POs [6] = global_term,     // pinName = A_out[5]; 
    part_POs [7] = global_term,     // pinName = A_out[6]; 
    part_POs [8] = global_term,     // pinName = A_out[7]; 
    part_POs [9] = global_term,     // pinName = PC_out[0]; 
    part_POs [10] = global_term,     // pinName = PC_out[1]; 
    part_POs [11] = global_term,     // pinName = PC_out[2]; 
    part_POs [12] = global_term,     // pinName = PC_out[3]; 
    part_POs [13] = global_term,     // pinName = PC_out[4]; 
    part_POs [14] = global_term,     // pinName = halted_out; 
    part_POs [15] = global_term;      // pinName = scan_out;  tf =  SO  ; 
...
//***************************************************************************//
  ...
  initial 
    begin 
      ...
      `ifdef sdf_annotate 
        `ifdef SDF_Minimum 
          $sdf_annotate ("default.sdf",processor_inst,,"sdf_Min.log","MINIMUM");
        `endif 
        `ifdef SDF_Maximum 
          $sdf_annotate ("default.sdf",processor_inst,,"sdf_Max.log","MAXIMUM");
        `endif 
        `ifdef SDF_Typical
          $sdf_annotate ("default.sdf",processor_inst,,"sdf_Typ.log","TYPICAL");
        `endif 
      `endif 
...
//***************************************************************************//
  ...
  task sim_setup; 
    begin 
      ...
      SERIALCYCLE = 0; 
      SEQNUM = 0; 
      name_POs [1] = "A_out[0]";      // pinName = A_out[0]; 
      name_POs [2] = "A_out[1]";      // pinName = A_out[1]; 
      name_POs [3] = "A_out[2]";      // pinName = A_out[2]; 
      name_POs [4] = "A_out[3]";      // pinName = A_out[3]; 
      name_POs [5] = "A_out[4]";      // pinName = A_out[4]; 
      name_POs [6] = "A_out[5]";      // pinName = A_out[5]; 
      name_POs [7] = "A_out[6]";      // pinName = A_out[6]; 
      name_POs [8] = "A_out[7]";      // pinName = A_out[7]; 
      name_POs [9] = "PC_out[0]";      // pinName = PC_out[0]; 
      name_POs [10] = "PC_out[1]";      // pinName = PC_out[1]; 
      name_POs [11] = "PC_out[2]";      // pinName = PC_out[2]; 
      name_POs [12] = "PC_out[3]";      // pinName = PC_out[3]; 
      name_POs [13] = "PC_out[4]";      // pinName = PC_out[4]; 
      name_POs [14] = "halted_out";      // pinName = halted_out; 
      name_POs [15] = "scan_out";      // pinName = scan_out;  tf =  SO  ; 
...
//***************************************************************************//
  ...
  task sim_vector_file; 
    begin 
      ...
      $display ( "\nINFO (TVE-189): Design:  processor   Test Mode:  FULLSCAN   InExperiment:  logic " ); 
  ...
  task test_cycle; 
    begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      part_PIs [5] = stim_PIs [5];      // pinName = test_mode; testOffset = 0.000000;  scanOffset = 0.000000;  
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
      ...
      part_PIs [2] = stim_PIs [2];      // pinName = reset;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #8.000000;        // 16.000000 ns;  From the start of the cycle.
      ...
      part_PIs [2] = stim_CIs [2];      // pinName = reset;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #56.000000;        // 72.000000 ns;  From the start of the cycle.

      for ( POnum = 1; POnum <= 15; POnum = POnum + 1 ) begin 
        if (( part_POs [ POnum ] !== meas_POs [ POnum ] ) & ( meas_POs [ POnum ] !== 1'bX )) begin 
          ...
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "processor", name_POs [ POnum ], PATTERN, -1, part_POs [ POnum ] ); 
          end  
        end  
  ...
  task Scan_Sequence_TM_1_SEQ_2_SOP_1; 
    begin 
     ...
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
        ...
        if (( part_POs [15] !== meas_OR_1 [ 0 + SCANCYCLE ] ) & ( meas_OR_1 [ 0 + SCANCYCLE ] !== 1'bX )) begin      // pinName = scan_out;  tf =  SO  ; 
          if ( test_num != failed_test_num )  begin 
            num_failed_tests = num_failed_tests + 1; 
            failed_test_num = test_num; 
          end  
          ...
          $display ( "           Expected: %0b   Simulated: %0b   Observe Register (OR) = 1;   Measured on Scan Cycle: %0d   Measured at SO: %0s   ", meas_OR_1 [ 0 + SCANCYCLE ], part_POs [15], SCANCYCLE, name_POs [15] ); 

          if (( failset ) & ( FAILSETID == 0 ))  failset_setup; 
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "processor", name_POs [15], PATTERN, SCANCYCLE, part_POs [15] ); 
          end  
        end  
        else  begin 
  ...
  task cmd_code; 
    begin 
      ...
      case ( CMD ) 
        ...
        202: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", meas_POs [1:15] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", stim_CR_1 [1:296] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", meas_OR_1 [1:296] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
        ...
        904: begin 
          ...
          if ( rc_read > 0 )  begin 
            `ifdef MISCOMPAREDEBUG 
              if ( diag_debug ) begin 
                $processSimulationDebugFile ( DIAG_DEBUG_FILE, "processor_inst", eventID ); 
              end 
            `endif 
          end  
          else  bad_cmd_code; 
